                        ...
                        {user ? (
                            <>
                                <div className="flex items-center gap-1 sm:gap-2">
                                    <Link to="/notifications" className="relative p-2 text-slate-500 hover:text-teal-700 transition-colors">
                                    ...
                                    <span className="text-sm font-medium text-slate-700 hidden lg:block">{user.fullName || user.name || user.username} ({user.role})</span>
                                </div>
                                <button
                                    onClick={handleLogout}
                                    className="inline-flex items-center px-3 py-2 sm:px-4 border border-transparent text-sm font-medium rounded-md text-white bg-slate-800 hover:bg-slate-700 focus:outline-none transition-colors"
                                >
